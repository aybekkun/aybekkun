...
export const CardSwapItem = forwardRef<HTMLDivElement, CardProps>(
...
CardSwapItem.displayName = "CardSwapItem"
...
const CardSwap: React.FC<CardSwapProps> = ({
	...
	return (
		<div
			ref={container}
			className=" transform translate-x-[5%] translate-y-[20%] origin-bottom-right perspective-[900px] overflow-visible"
			style={{ width, height }}
		>
			{rendered}
		</div>
